...
Write-Host "⚡ Starting Backend API Server on http://localhost:8888..." -ForegroundColor Yellow
Start-Process powershell -ArgumentList "-NoExit", "-Command", "cd backend; .\venv\Scripts\python -m uvicorn app.main:app --port 8888 --reload"

# 2. Start Frontend in a new window
Write-Host "⚡ Starting Frontend Dev Server on http://localhost:5555..." -ForegroundColor Yellow
