    ...
    async def stream_intent(
        ...
        if is_voice_chat:
            ...
            system_instruction = (
                ...
                "   - VISUAL DIAGRAMS AND SCHEMATICS: If explaining any scientific, technical, mechanical, medical, biological, historical, or visual concept, ALWAYS embed 1 to 3 compact educational illustrations/diagrams. Use this EXACT URL format for each image — replace DESCRIPTION with a URL-encoded description (no spaces, use underscores or %20): `![Description](https://image.pollinations.ai/prompt/DESCRIPTION?width=800&height=600&nologo=true&model=flux)`. IMPORTANT: Do NOT include raw & characters inside the markdown parentheses. Construct the URL like this example: `![Binary Number System](https://image.pollinations.ai/prompt/binary_number_system_educational_diagram_labeled_schematic?width=800&height=600&nologo=true&model=flux)`.\n"
